      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <form onSubmit={handleSearch} className="mb-8 flex justify-start gap-2">
          ...
          <button
            onClick={() => fetchNews(1)}
            disabled={loading}
            className="px-3 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-sm rounded-lg transition-colors disabled:opacity-50"
            title="Làm mới"
          >
