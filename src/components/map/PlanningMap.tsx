...
export function PlanningMap() {
  ...
  const geocodeAndMove = async () => {
    const query = [selectedWard, selectedProvince].filter(Boolean).join(', ');
          ...
          <div className="glass-morphism rounded-3xl border border-white/10 shadow-3xl p-6 space-y-5 animate-in slide-in-from-left-4 duration-300">
            ...
            <div className="space-y-4">
              <LocationSelector
                ...
                showLabels={false}
                className="[&_select]:bg-white/5 [&_select]:border-white/10 [&_select]:text-white [&_select]:rounded-xl [&_select]:py-2.5 [&_select]:focus:ring-orange-500 [&_option]:bg-slate-900"
              />
